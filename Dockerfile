...
ENV JAVA_OPTS="-server -Xmx1400m -Xms1400m -Xmn600m -Duser.timezone=UTC -Dfile.encoding=UTF-8 -XX:+UseParallelGC -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:CompileThreshold=1"
EXPOSE 80
