...
ENV JAVA_OPTS="-server -XX:GCTimeRatio=1000 -Xmx1220m -Xms1220m -Xmn600m -Duser.timezone=UTC -Dfile.encoding=UTF-8 -XX:+UseSerialGC -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:CompileThreshold=1"
EXPOSE 80
